...
`../tests/fixture/Cargo.toml` for a complete manifest.
...
full protocol/shutdown audit in [`tracy-embedded-capture/docs/architecture.md`](../../tracy-embedded-capture/docs/architecture.md).
...
[`tracy-embedded-capture/docs/architecture.md`](../../tracy-embedded-capture/docs/architecture.md) for that measurement's full environment and
methodology.
